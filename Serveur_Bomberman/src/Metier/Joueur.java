...
public class Joueur implements Serializable {
	...
	public String toString() {
		return "Joueur [id=" + id + ", email=" + email + ", motDePasse=" + motDePasse + ", pseudo=" + pseudo
				+ ", date_create=" + date_create + ", sexe=" + sexe + ", niveau=" + niveau + ", cheminAvatar="
				+ cheminAvatar + ", nbr_victoire=" + nbr_victoire + ", nbr_defaite=" + nbr_defaite + ", score_max="
				+ score_max + "]";
	}
	
	public String toRequete() {
		return "dataJoueur<>idJoueur:"+id+",pseudo:"+pseudo+",cheminAvatar:"+cheminAvatar+",niveau:"+niveau+",score_max:"+score_max;
	}
}
