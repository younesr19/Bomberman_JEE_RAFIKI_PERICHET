...
public final class ModificationForm {
    ...
    public Joueur modifierJoueur( HttpServletRequest request ) {
        String motDePasse = getValeurChamp( request, CHAMP_PASS );
        String confirmation = getValeurChamp( request, CHAMP_CONF );
        String pseudo = getValeurChamp( request, CHAMP_PSEUDO );
        System.out.println("Sexe "+getValeurChamp(request,CHAMP_SEXE));
        ...
        if ( erreurs.isEmpty() ) {
            resultat = "Succès de la modification !. <a href='Connexion'>Connectez-vous ! </a>";
        } else {
